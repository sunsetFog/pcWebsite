        ...
        <div class="varieties-content">
            ...
            <div class="payment-content">
                ...
                <div class="recharge-money">
                    ...
                    <img src="@sky/static/picture/recharge/xiaochu.png" @click="money = ''"/>
                </div>
...
export default {
    ...
    data(){
        return{
            ...
            money: '',
            money_list: [
                {name: 100,url: require('@sky/static/picture/recharge/100.png'),padding: '0px'},
                {name: 300,url: require('@sky/static/picture/recharge/300.png'),padding: '0px'},
                {name: 500,url: require('@sky/static/picture/recharge/500.png'),padding: '0px'},
                {name: 1000,url: require('@sky/static/picture/recharge/1000.png'),padding: '0px'},
                {name: 1500,url: require('@sky/static/picture/recharge/1500.png'),padding: '0px'},
                {name: 3000,url: require('@sky/static/picture/recharge/3000.png'),padding: '0px'},
                {name: 5000,url: require('@sky/static/picture/recharge/5000.png'),padding: '0px'},
                {name: 9999,url: require('@sky/static/picture/recharge/9999.png'),padding: '0px'}
            ],
            first_index: null,
            second_index: null,
            no_have: false,
    ...
    .varieties-content{
        ...
        .payment-content{
            ...
            .payment-methods{
                ...
                font-size: @font_size20;
                .mode-active{
                    .mixin_image(url('~@sky/static/picture/recharge/kuangkuang.png'));
                }
                ul{
                    li{
                        .mixin_li(auto,45px);
                        ...
                        .mixin_image(url('~@sky/static/picture/recharge/zhifufangshi.png'));
                        color: @color_white;
                        cursor: pointer;
                    }
                }
                ...
                ul{
                    li{
                        ...
                        span{
                            ...
                            .mixin_image(url('~@sky/static/picture/recharge/money.png'));
                            img{
                                .mixin_img(53.5%,60%);
                                float: left;
                                margin: 7% 0 0 21.4%;
