                ...
                <div class="head-example" v-if="portrait_index==0">
                    <ul>
                        <li v-for="(item,index) in portrait_head" @click="headMeans(index)">
                            <img :src="item.url"/>
                            <img v-show="item.active" src="@sky/static/picture/portrait/gougou.png"/>
                        </li>
                    </ul>
                </div>
...
export default {
    ...
    data(){
        return{
            ...
            head: require('@sky/static/picture/portrait/ui_headImg_1.png'),
            frame: require('@sky/static/picture/portrait/ui_headBox_1.png'),
            portrait_index: 0,
            head_index: 0,
            box_index: 0,
            save_head: 0,
            save_box: 0,
            portrait_head: [
                {url: require('@sky/static/picture/portrait/ui_headImg_1.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headImg_2.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headImg_3.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headImg_4.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headImg_5.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headImg_6.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headImg_7.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headImg_8.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headImg_9.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headImg_10.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headImg_11.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headImg_12.png'),active: false}
            ],
            portrait_box: [
                {url: require('@sky/static/picture/portrait/ui_headBox_1.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headBox_2.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headBox_3.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headBox_4.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headBox_5.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headBox_6.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headBox_7.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headBox_8.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headBox_9.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headBox_10.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headBox_11.png'),active: false},
                {url: require('@sky/static/picture/portrait/ui_headBox_12.png'),active: false}
            ],
        }
    },
    methods:{
