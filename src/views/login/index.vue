                    ...
                    <form>
                        ...
                        <div class="password-enter">
                            ...
                            <input :type="eyeType" maxlength="12" v-model.trim="password_number" placeholder="请输入登陆密码"
                                ...
                                @blur="readonly = true"/>
                            <div @click="eyeMeans">
                                <img v-if="eyeType == 'text'" class="zhengyan" src="@sky/static/picture/login/zhengyan.png" />
                                <img v-else class="biyan" src="@sky/static/picture/login/biyan.png" />
                            </div>
                        </div>
                    </form>
                    <div class="remember-and-forget">
                        <div class="rectangle" @click="remember_checked = !remember_checked"><img v-show="remember_checked"
                                src="@sky/static/picture/login/jizhu.png" /></div>
                        <span>记住密码</span>
...
#login {
    ...
    .entertainment {
        ...
        .sign-frame {
            width: 480px;
            height: 400px;
            .mixin_image(url('~@sky/static/picture/login/kuankuan.png'));
            position: absolute;
            top: 190px;
            left: 50%;
            margin-left: -240px;
            ...
            .code-and-service {
                ...
                span:nth-of-type(1) {
                    ...
                    height: 34px;
                    float: right;
                    .mixin_image(url('~@sky/static/picture/login/kefu.png'));
                    cursor: pointer;
                    margin: 3px 3px 0px 0px;
                }

                span:nth-of-type(1):hover {
                    .mixin_image(url('~@sky/static/picture/login/kefu_hover.png'));
                }
            }
            ...
            .form-information {
                ...
                .password-enter {
                    width: 100%;
                    height: 50px;
                    .mixin_image(url('~@sky/static/picture/login/juxingkuang.png'));
                    color: @color_white;
                    border-radius: 4px;
                ...
                .remember-and-forget {
                    ...
                    .rectangle {
                        width: 18px;
                        height: 18px;
                        .mixin_image(url('~@sky/static/picture/login/fuxuankuang.png'));
                        position: absolute;
                        top: 50%;
                        left: 5px;
                        margin-top: -9px;
                ...
                .login-register {
                    ...
                    span:nth-of-type(1) {
                        ...
                        font-size: 16px;
                        font-weight: 600;
                        .mixin_image(url('~@sky/static/picture/login/denglu.jpg'));
                    }

                    span:nth-of-type(1):hover {
                        .mixin_image(url('~@sky/static/picture/login/denglu_hover.jpg'));
                    }
                    ...
                    span:nth-of-type(2) {
                        ...
                        font-size: 16px;
                        font-weight: 600;
                        .mixin_image(url('~@sky/static/picture/login/kuaisuzhuce.jpg'));
                    }

                    span:nth-of-type(2):hover {
                        .mixin_image(url('~@sky/static/picture/login/kuaisuzhuce_hover.jpg'));
                    }
                }
                ...
                .optimal {
                    width: 100%;
                    height: 50px;
                    .mixin_image(url('~@sky/static/picture/login/xuanxian.png'));
                    cursor: pointer;
                    font-size: 16px;
                    font-weight: 600;
                }
                ...
                .optimal:hover {
                    .mixin_image(url('~@sky/static/picture/login/xuanxian_hover.png'));
                }
            }
        }
    }
