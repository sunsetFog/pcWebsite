...
<script>
	export default{
		...
		// 	},
        //     // 问题：filters里this为undefined    解决：noThis(times) 方法带参数进来
		// 	noThis(value, isThis) {
