<template>
    <section class="tableUnit">
        <main>
            <div class="mercury">
                <div class="header">
                    <img src="@/assets/position/img_title_02.png" />
                </div>
    ...
    main {
        ...
        .mercury {
            ...
            .header {
                ...
                background: url('~@/assets/position/box_top.png');
            ...
            .honey {
                width: 100%;
                background-image: url('~@/assets/position/box_body.png');
            ...
            .footer {
                width: 100%;
                height: 250px;
                background-image: url('~@/assets/position/box_bom.png');
                background-repeat: no-repeat;
        ...
        .lotus {
            width: 1743px;
            height: 760px;
            background-image: url('~@/assets/position/img_mod_btm01.png');
            background-size: 100% 100%;
            background-repeat: no-repeat;
            position: absolute;
            left: -129px;
