        ...
        <header>
            <ul>
                <li v-for="(item, index) in vip_list" :key="index" @click="pointNum = index">
                    <img :src="require(`@sky/static/picture/rotationChart/vipIcon/vip_icon_${index}_ash.png`)"/>
                    <p>{{ item.name }}</p>
                </li>
                <div></div>
            ...
            <ul :style="moveApt" @mousedown="downWay" @mousemove="moveWay" id="to-go">
                ...
                <li v-for="(item, index) in vip_list" :key="index">
                    <div :class="{'parallax': pointNum == index}">
                        <img :src="require(`@sky/static/picture/rotationChart/card_vip${index}.png`)"/>
                        <img v-if="index < 5" :src="require(`@sky/static/picture/rotationChart/vip_icon_unlock.png`)"/>
                        <img v-else :src="require(`@sky/static/picture/rotationChart/vip_icon_locked.png`)"/>
                    </div>
                </li>
                <li></li>
            </ul>
...
#rotationChart {
    ...
    header {
        ...
        ul {
            ...
            div:nth-of-type(1) {
                width: @li-width * 3;
                background: url('~@sky/static/picture/rotationChart/vipIcon/line_un.png');
            ...
            div:nth-of-type(2) {
                background: url('~@sky/static/picture/rotationChart/vipIcon/line_ac.png');
    ...
    .prev {
        left: 10px;
        background: url('~@sky/static/picture/rotationChart/vip_icon_left_sele.png');
        background-size: 100% 100%;
        background-repeat: no-repeat;
        &:hover {
            background: url('~@sky/static/picture/rotationChart/vip_icon_left.png');
            background-size: 100% 100%;
            background-repeat: no-repeat;
        }
    }
    .next {
        right: 10px;
        background: url('~@sky/static/picture/rotationChart/vip_icon_right_sele.png');
        background-size: 100% 100%;
        background-repeat: no-repeat;
        &:hover {
            background: url('~@sky/static/picture/rotationChart/vip_icon_right.png');
            background-size: 100% 100%;
            background-repeat: no-repeat;
        }
    }
    ...
    .shadow {
        width: @li-width;
        height: 44px;
        background: url('~@sky/static/picture/rotationChart/shadow.png');
        background-size: 100% 100%;
        background-repeat: no-repeat;
        position: absolute;
